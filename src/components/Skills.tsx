    ...
    <section id="skills" className="py-24 px-4 section-alt">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="card-elevated relative overflow-hidden p-5 rounded-xl animate-fade-in" style={{ animationDelay: "240ms" }}>
          <BorderBeam size={100} duration={12} colorFrom="#0369a1" colorTo="#f59e0b" borderWidth={1} />
          <BorderBeam size={100} duration={12} colorFrom="#f59e0b" colorTo="#0369a1" borderWidth={1} reverse delay={6} />
