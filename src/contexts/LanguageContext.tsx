...
const translations = {
  es: {
    ...
    // Companies
    "companies.dacodes.task1": "Lideré el diseño técnico y las decisiones de arquitectura de una plataforma de salud con React 18 y Scala, mejorando la programación de citas y los flujos de contratos.",
    "companies.dacodes.task2": "Reduje el tiempo de respuesta de APIs críticas en 40% mediante optimización de consultas en Oracle 19c y estrategias de caché en AWS RDS.",
    "companies.dacodes.task3": "Implementé patrones de manejo de datos compatibles con HIPAA en microservicios cloud-native usando AWS Lambda, S3 y CloudWatch.",
    "companies.dacodes.task4": "Establecí estándares de code review y mejoras en CI/CD que redujeron el tiempo de despliegue en 30% para el equipo.",
    "companies.dacodes.task5": "Mentoricé a un equipo de frontend de 3 personas en buenas prácticas de React 18, hooks avanzados y optimización de rendimiento.",
    "companies.outcoding.task1": "Arquitecté la migración a una Arquitectura Hexagonal, reduciendo el acoplamiento entre 8 microservicios y mejorando la testabilidad en 60%.",
    "companies.outcoding.task2": "Construí micro-frontends en Angular para la gestión de pólizas de seguros y el scoring de riesgo de conductores, integrados con APIs en Java 17.",
    "companies.outcoding.task3": "Alcancé más de 95% de cobertura de tests con JUnit 5, Mockito y Jest, cumpliendo los requisitos de CI/CD empresarial en Azure.",
    "companies.outcoding.task4": "Implementé flujos de autenticación OAuth 2.0 + OIDC con Azure AD para el SSO corporativo de más de 10,000 usuarios.",
    "companies.outcoding.task5": "Lideré la iniciativa de descomposición de un monolito en 5 servicios independientes y desplegables con Kubernetes.",
    "companies.globant.task1": "Desarrollé más de 15 APIs REST para banca en línea (transferencias, gestión de cuentas, tarjetas de crédito), sirviendo a más de 500K clientes.",
    "companies.globant.task2": "Integré la comunicación entre servicios con Spring Cloud Gateway y Feign, usando patrones circuit breaker para mayor resiliencia.",
    "companies.globant.task3": "Implementé programación reactiva con Spring WebFlux, mejorando el throughput en 35% bajo carga pico bancaria.",
    "companies.globant.task4": "Entregué funcionalidades de pago compatibles con PCI-DSS en un entorno bancario altamente regulado, con pipelines de CI/CD robustos.",
    "companies.bridge.task1": "Diseñé e implementé más de 50 microservicios REST bancarios con Java 11 y Spring Boot 2.x para operaciones core del negocio.",
    "companies.bridge.task2": "Construí una arquitectura event-driven con Apache Kafka, procesando más de 5M de mensajes/día para transacciones en tiempo real.",
    "companies.bridge.task3": "Desarrollé un portal bancario con React 16 + Redux para más de 50K usuarios activos diarios, soportando productos financieros orientados al cliente.",
    "companies.bridge.task4": "Desplegué y gestioné servicios en Azure Kubernetes Service (AKS) con Helm charts, Zipkin y el stack ELK para observabilidad.",
  ...
  en: {
    ...
    // Companies
    "companies.dacodes.task1": "Led technical design and architecture decisions for a healthcare platform built with React 18 and Scala, improving appointment scheduling and contract workflows.",
    ...
    "companies.outcoding.task1": "Architected a Hexagonal Architecture migration, reducing coupling across 8 microservices and improving testability by 60%.",
    ...
    "companies.outcoding.task5": "Led a monolith decomposition initiative, breaking a legacy system into 5 independently deployable Kubernetes services.",
